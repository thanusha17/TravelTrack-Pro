    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0b0f19] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass rounded-2xl p-8 shadow-2xl relative z-10">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold tracking-tight text-white mb-2">TravelTrack <span className="text-brand-500">Pro</span></h2>
          <p className="text-gray-400 text-sm">Sign in to manage your international travel finances</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-400 text-sm">
            ...
            <Link to="/signup" className="text-brand-400 hover:text-brand-300 font-medium transition-all">
              Create an account
            </Link>
          </p>
        </div>
